...
namespace PresentacionGrupo.Models
{
    public class Curso
    {
        ...
        public Curso()
        {
            ...
            private static Integrante Bauti = new Integrante(50046913, "Bauti", "*fotoAzteka*", fecha, family, intereses);
            ...
            intereses.Clear();
            intereses.Add("Chinos HOT");
            intereses.Add("Bandalizar propiedad del Estado.")
            private static Integrante Llara = new Integrante(46982167, "Kyara", "*AsiáticaCHINA*", fecha, family, intereses);
